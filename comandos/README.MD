...
```
git config --global user.name 'Seu nome' --------------- git config --global user.name 'RafaelGomesdeOliveira'
git config --global user.email 'seuemail@gmail.com' -- git config --global user.email 'rafaelgoliveiraa@gmail.com'
